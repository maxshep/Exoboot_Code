...
# Account Information
to = 'maxshepherd5790@gmail.com'  # Email to send to.
gmail_user = 'ExoBootIpMailer@gmail.com'  # Email to send from. (MUST BE GMAIL)
gmail_password = 'exoboot1234'  # Gmail password.
